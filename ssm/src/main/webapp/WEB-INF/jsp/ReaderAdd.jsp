            ...
            <div class="box-body">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#tab-label" data-toggle="tab">添加读者界面显示</a>
                        </li>
                    </ul>
                    <!--tab头/-->
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab-label">
                            <form action="${pageContext.request.contextPath}/reader/add" method="get">
                                <h5>四列 , 行两个项目</h5>
                                ...
                                <div class="row data-type">
                                    ...
                                    <input class="col-md-4 data text" type="text" name="age">
                                    ...
                                    <input type="text" name="phone" class="col-md-4 data text">

                                    <div class="col-md-2 title">读者所在系</div>
                                    <input type="text" name="dept" class="col-md-10 data text">
                                    <div class="col-md-2 title">读者用户名</div>
                                    <input type="text" name="username" class="col-md-10 data text">
                                    <div class="col-md-2 title">读者密码</div>
                                    <input type="text" name="password" class="col-md-10 data text">
                                        ...
                                        <div class="row data-type">
                                            ...
                                            <div class="col-md-10 data">
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" name="regdate" class="form-control pull-right" id="datepicker">
                                                </div>
                                            </div>
