            ...
            <div class="box-body">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#tab-label" data-toggle="tab">更改图书界面显示</a>
                        </li>
                    </ul>
                    <!--tab头/-->
                        ...
                        <div class="tab-pane active" id="tab-label">
                            <form action="${pageContext.request.contextPath}/book/update" method="post">
                                ...
                                <div class="row data-type">
                                    ...
                                    <input class="col-md-4 data text" type="text" value="${book.name}" name="name">
                                    <div class="col-md-2 title">图书类型</div>
                                    <div class="col-md-4 data text">
                                        <c:choose>
                                            <c:when test="${book.type eq '历史'}" >
                                                <input type="radio" name="type" value="计算机" >计算机
                                                <input type="radio" name="type" value="励志">励志
                                                <input type="radio" name="type" value="西方文学">西方文学
                                                <input type="radio" name="type" value="历史"checked="checked">历史
                                            </c:when>
                                            <c:when test="${book.type eq '计算机'}" >
                                                <input type="radio" name="type" value="计算机" checked="checked">计算机
                                                <input type="radio" name="type" value="励志">励志
                                                <input type="radio" name="type" value="西方文学">西方文学
                                                <input type="radio" name="type" value="历史">历史
                                            </c:when>
                                            <c:when test="${book.type eq '励志'}" >
                                                <input type="radio" name="type" value="计算机">计算机
                                                <input type="radio" name="type" value="励志" checked="checked">励志
                                                <input type="radio" name="type" value="西方文学">西方文学
                                                <input type="radio" name="type" value="历史">历史
                                            </c:when>
                                            <c:otherwise>
                                                <input type="radio" name="type" value="计算机">计算机
                                                <input type="radio" name="type" value="励志">励志
                                                <input type="radio" name="type" value="西方文学" checked="checked">西方文学
                                                <input type="radio" name="type" value="历史">历史
                                        </c:otherwise>
                                        </c:choose>
                                    </div>
                                    <div class="col-md-2 title">图书作者</div>
                                    <input type="text" name="author" value="${book.author}" class="col-md-4 data text">

                                    <div class="col-md-2 title">图书价格</div>
                                    <input type="text" name="price" value="${book.price}" class="col-md-4 data text">

                                    <div class="col-md-2 title">图书库存</div>
                                    <input type="text" name="number" value="${book.number}" class="col-md-10 data text">
