            ...
            <div class="box-body">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#tab-label" data-toggle="tab">更改读者界面显示</a>
                        </li>
                    </ul>
                    <!--tab头/-->
                        ...
                        <div class="tab-pane active" id="tab-label">
                            <form action="${pageContext.request.contextPath}/reader/update" method="post">
                                ...
                                <div class="row data-type">
                                    <input type="hidden" value="${reader.readerid}" name="readerid">
                                    <div class="col-md-2 title">读者姓名</div>
                                    <input class="col-md-4 data text" type="text" value="${reader.name}" name="name">
                                    <div class="col-md-2 title">读者年龄</div>
                                    <input class="col-md-4 data text" type="text" value="${reader.age}" name="age">

                                    <div class="col-md-2 title">读者性别</div>
                                    ...
                                    <div class="col-md-2 title">读者手机</div>
                                    <input type="text" name="phone" value="${reader.phone}" class="col-md-4 data text">

                                    <div class="col-md-2 title">读者所在系</div>
                                    <input type="text" name="dept" value="${reader.dept}" class="col-md-10 data text">
                                    <div class="col-md-2 title">读者用户名</div>
                                    <input type="text" name="username" value="${reader.username}" class="col-md-10 data text">
                                    <div class="col-md-2 title">读者密码</div>
                                    <input type="text" name="password" value="${reader.password}" class="col-md-10 data text">
                                        ...
                                        <div class="row data-type">
                                            ...
                                            <div class="col-md-10 data">
                                                <div class="input-group date">
                                                    ...
                                                    <div type="text" name="regdate" class="form-control pull-right" id="datepicker">${reader.regdate}</div>
                                                </div>
                                            </div>
